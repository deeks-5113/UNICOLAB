...
export default function WaveBackground({
    className = "",
    strokeColor = "rgba(148, 163, 184, 0.2)", // Slate 400 with opacity
    backgroundColor = "transparent", // Transparent to show cosmic bg
}: WaveBackgroundProps) {
    ...
    // Using any for paths due to SVGPathElement interaction
    ...
    const setLines = () => {
        ...
        const xGap = 15;  // Adjusted spacing for performance/visual balance
        const yGap = 15;
        ...
        for (let i = 0; i < totalLines; i++) {
            ...
            path.setAttribute('stroke-opacity', '0.2'); // Added opacity for better blending
