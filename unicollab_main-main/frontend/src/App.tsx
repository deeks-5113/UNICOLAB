    ...
    >
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/projects/:projectId/applications" element={<ProtectedRoute><AppShell><ProjectApplicationsPage /></AppShell></ProtectedRoute>} />
          <Route path="/projects/:projectId/chat" element={<ProtectedRoute><AppShell><TeamChatPage /></AppShell></ProtectedRoute>} />
        </Routes>
      </BrowserRouter>
